...
class SGL(GraphProPluginModel):
    ...
    def cal_loss(self, batch_data):
        ...
        if edge_times is not None:
            cl_loss = self.lbd * self.cal_cl_loss([users, pos_items], [edges_1, edge_norm[dropout_mask_1], edge_times[dropout_mask_1]], [edges_2, edge_norm[dropout_mask_2], edge_times[dropout_mask_2]])
        else:
