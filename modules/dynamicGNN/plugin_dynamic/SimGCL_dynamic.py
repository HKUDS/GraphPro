...
class BaseModel_1(BaseModel):
    ...
    def cal_cl_loss(self, idx, edges, edge_norm):
        ...
        user_view_1, item_view_1 = self.forward(edges, edge_norm, perturbed=True)
        user_view_2, item_view_2 = self.forward(edges, edge_norm, perturbed=True)
    ...
    def cal_loss(self, batch_data):
        ...
        cl_loss = self.lbd * self.cal_cl_loss([users,pos_items], edges, edge_norm)
...
class SimGCL_evolveGCN_O(BaseModel_1):
    ...
    def forward(self, edges, edge_norm, edge_times=None, return_res_emb=False, perturbed=False):
...
class SimGCL_evolveGCN_H(BaseModel_1):
    def __init__(self, dataset, pretrained_model=None, last_emb=None):
        super().__init__(dataset)
...
class SimGCL_roland(BaseModel_1):
